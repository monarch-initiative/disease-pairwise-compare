...
if __name__ == '__main__':
    ...
    def parse_input_command():
        ...
        parser.add_argument("-m","--sim_metric", help="similarity metric to use", required=False, type=str, default="ps", choices=["ps", "js", "aic"])
    ...
    # Read in results file to memory
    outname = "disease_pairwise_similarity_results.pkl.gz"
